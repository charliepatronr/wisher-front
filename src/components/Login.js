...
export default function Login() {
  ...
  const [formInputs, setInputs]= useState({email: '', password: ''})

  const handleSubmit = (e, formInputs)=> {
      e.preventDefault();
      console.log(formInputs.email, 'EMAIL')
      console.log(formInputs.password, 'PASSWORD')
  }
    ...
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <div className={classes.paper}>
          ...
          <Typography component="h1" variant="h5">w
            Sign in
          </Typography>
          <form className={classes.form} noValidate onSubmit={(e)=> handleSubmit(e, formInputs)}>
            <TextField
              variant="outlined"
              margin="normal"
              required
